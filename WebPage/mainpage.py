...
availableStocks = ["AAL","AAP","AAPL","ABBV","ABC","ABMD","ABT","ACN","A","ADBE","ADI","ADM",
                   ...
                   "FDX","FE","FFIV","FIS","FISV","FITB","FLIR","FLS","FLT","FMC","FOXA","FOX","FRC",
                   ...
                   "VNO","VNT","VRSK","VRSN","VRTX","VTR","VTRS","VZ","WAB","WAT","WBA","WDC","WEC","WELL",
                   "WFC","WHR","WLTW","WMB","WM","WMT","WRB","WRK","WST","WU","WY","WYNN","XEL","XLNX",
                   "XOM","XRAY","XRX","XYL","YUM","ZBH","ZBRA","ZION","ZTS"]

@app.route('/')
def home_page():
    return render_template('index.html', availableStocks = availableStocks)
